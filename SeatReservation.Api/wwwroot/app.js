...
/***/ function(module, exports) {
	...
	var _user$project$Events_Models$new = {id: '', name: ''};
	var _user$project$Events_Models$Event = F2(
		function (a, b) {
			return {id: a, name: b};
		});

	var _user$project$Events_Messages$FetchAllFail = function (a) {
		return {ctor: 'FetchAllFail', _0: a};
	};
	var _user$project$Events_Messages$FetchAllDone = function (a) {
		return {ctor: 'FetchAllDone', _0: a};
	};

	var _user$project$Events_Commands$memberDecoder = A3(
		_elm_lang$core$Json_Decode$object2,
		_user$project$Events_Models$Event,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'id', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'name', _elm_lang$core$Json_Decode$string));
	var _user$project$Events_Commands$collectionDecoder = _elm_lang$core$Json_Decode$list(_user$project$Events_Commands$memberDecoder);
	var _user$project$Events_Commands$fetchAllUrl = 'http://localhost:53006/api/events';
	var _user$project$Events_Commands$fetchAll = A3(
		_elm_lang$core$Task$perform,
		_user$project$Events_Messages$FetchAllFail,
		_user$project$Events_Messages$FetchAllDone,
		A2(_evancz$elm_http$Http$get, _user$project$Events_Commands$collectionDecoder, _user$project$Events_Commands$fetchAllUrl));
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(event.name)
						])),
					A2(
					_elm_lang$html$Html$td,
					_elm_lang$core$Native_List.fromArray(
	...
	var _user$project$Events_List$list = function (events) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Native_List.fromArray(
								[]),
							A2(_elm_lang$core$List$map, _user$project$Events_List$eventRow, events))
						]))
				]));
	};
	var _user$project$Events_List$nav = function (events) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
	...
	var _user$project$Events_List$view = function (events) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Events_List$nav(events),
					_user$project$Events_List$list(events)
				]));
	};

	var _user$project$Events_Update$update = F2(
		function (message, events) {
			var _p0 = message;
			if (_p0.ctor === 'FetchAllDone') {
				return {ctor: '_Tuple2', _0: _p0._0, _1: _elm_lang$core$Platform_Cmd$none};
			} else {
				return {ctor: '_Tuple2', _0: events, _1: _elm_lang$core$Platform_Cmd$none};
			}
		});

	var _user$project$Login_Messages$NoOp = {ctor: 'NoOp'};

	var _user$project$Login_Models$new = {email: '', password: ''};
	var _user$project$Login_Models$Credentials = F2(
		function (a, b) {
	...
	var _user$project$Login_View$view = function (credentials) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[]),
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$placeholder('E-Mail')
						]),
					_elm_lang$core$Native_List.fromArray(
						[])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Events$onClick(_user$project$Login_Messages$Login)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
	...
	var _user$project$Messages$EventMsg = function (a) {
		return {ctor: 'EventMsg', _0: a};
	};
	...
	var _user$project$Models$initialModel = {
		credentials: _user$project$Login_Models$new,
		events: _elm_lang$core$Native_List.fromArray(
			[])
	};
	var _user$project$Models$Model = F2(
		function (a, b) {
			return {credentials: a, events: b};
		});

	var _user$project$View$page = function (model) {
		return A2(
			_elm_lang$html$Html_App$map,
			_user$project$Messages$EventMsg,
			_user$project$Events_List$view(model.events));
	};
	...
	var _user$project$Update$update = F2(
		function (msg, model) {
			var _p0 = msg;
			if (_p0.ctor === 'EventMsg') {
				var _p1 = A2(_user$project$Events_Update$update, _p0._0, model.events);
				var updatedEvents = _p1._0;
				var cmd = _p1._1;
				return {
					ctor: '_Tuple2',
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$EventMsg, cmd)
				};
			} else {
				var _p2 = A2(_user$project$Login_Update$update, _p0._0, model.credentials);
				var updatedCredentials = _p2._0;
				var cmd = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
	...
	var _user$project$Main$init = {
		...
		_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Messages$EventMsg, _user$project$Events_Commands$fetchAll)
	};
